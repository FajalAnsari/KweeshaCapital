 ...
 <!--============  Navbar section start ===================-->
  <header className="p-2 fixed shadow">
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
        <div class="container">
            <a href="index.html"><img src="images/kweesha_capital_logo.png" class="img-fluid navbar-brand" alt="logo"></a>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/kweesha_hero.jpg" class="d-block w-100" alt="...">
       ...
       <div class="container-fluid">
          <div class="row">
              <div class="col-lg-4 a">
                 <div class="me-5 position-relative aa"><img src="./images/about9.jpg" class="about_img mt-5 mb-5 img-fluid"></div>
              </div>
              <div class="col-lg-8 b">
                 <div class="about_text text-center p-5">
                 <div class="text-start about_para_box">
                   <h2 class="text-white w-50 mx-auto mt-1 about_para fs-3 lh-base text-capitalize">Elevate your business to new heights with our innovative financial solutions</h2>
                 </div>
                   <div class="ms-4"><h6 class="w-50 text-white-50 mt-5  mx-auto lh-lg about_desp" style="text-align: justify;">At KweeshaCapital, our innovative financial solutions are designed with one goal in mind - to elevate your business to new heights. Our team of financial experts and analysts are adept at streamlining lead generation, refining financial models, and optimizing every segment of your operations.   <br /> <br /> We dive deep into the undercurrents of your business, identifying areas where growth opportunities are lost, and apply our unique analytical approach to maximize your potential.
                    <br /> <br />
    ...
    <div class="case_studies_section section" id="case_studies">
       <div class="container-fluid">
        ...
        <div class="section-title text-center p-5">
          ...
          <div class="row">
            <div class="col-lg-8 b">
                <div class="about_text text-center p-5">
                    <div class="text-start about_para_box">
                      <h2 class="text-white w-50 mx-auto mt-1 about_para fs-3 lh-base text-capitalize">Discover how we've helped lenders transform their operations and enhance growth</h2>
                    </div>
                      <div class="ms-4"><h6 class="w-50 text-white-50 mt-5 text-start mx-auto lh-lg about_desp"  style="text-align: justify;">Our commitment to transforming the lending landscape is evident in the success stories we have helped write. Our case studies demonstrate the power of innovative approaches, meticulous analysis, and a relentless drive for improvement.   <br /> <br /> of innovative approaches, meticulous analysis, and a relentless drive for improvement. Explore how we have empowered lenders to streamline their operations, create robust financial models, and enhance their lead generation strategies.
                       <br /> <br />
                       Each case is a journey of transformation, demonstrating how businesses can move from survival to success with Kweesha Capital as their trusted partner.
                   </h6></div>
                    <div class="mt-5 button_about">
                      <button class="text-center p-2 w-25 about_btn border-0 text-white fs-5">Read More</button>
                    </div>
        ...
        <div class="col-lg-4 a">
            <div class="me-5 position-relative"><img src="./images/about8.jpg" class="about_img mt-5 mb-5 img-fluid"></div>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="About_Section section"  id="about">
        <div class="container-fluid">
           ...
           <div class="row">
               <div class="col-lg-4 a">
                  <div class="me-5 position-relative"><img src="./images/about10.jpg" class="about_img mt-5 mb-5 img-fluid"></div>
               </div>
               <div class="col-lg-8 b">
                <div class="about_text text-center p-5">
                    <div class="text-start about_para_box">
                      <h2 class="text-white w-50 mx-auto mt-1 about_para fs-3 lh-base text-capitalize">Meet Kweesha Capital - a force for change in the lending industry</h2>
                    </div>
                    <div class="ms-4"><h6 class="w-50 text-white-50 mt-5 text-start mx-auto lh-lg about_desp"  style="text-align: justify">Kweesha Capital is more than just a financial consulting firm - we are a force for change in the lending industry. Our team, composed of financial strategists, analysts, and operations experts, is dedicated to tailoring solutions that propel growth and success.   <br /> <br />  We employ an analytical approach that sets us apart, enabling us to uncover hidden opportunities and devise strategies that are as unique as your business.
                       <br /> <br />
                       With a steadfast commitment to fairness and transparency, we strive to create a robust financial environment that benefits not only lenders but also the small businesses and individuals they serve.
                   </h6></div>
                   ...
                   <div class="p-5 gg">
                    <div class="info">
                        <div class="address">
                          ...
                          <h4>Location:</h4>    
                          <p>16Navneet Vihar, Sector 9, Indira Nagar, Lucknow, Uttar Pradesh 226021</p>
                        </div>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14234.678331540266!2d81.0018291!3d26.882237!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399be34af2e0d36f%3A0x13fc545254663b45!2sDo%20It%20For%20Me%20LLC!5e0!3m2!1sen!2sin!4v1687926617408!5m2!1sen!2sin" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen></iframe>
                      </div>
                    </div>
                </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="images/kweesha_capital_footer_logo.png" class="img-fluid" alt="logo"></a>
                            </div>
                            <div class="footer-text w-75">
                                <p class="text-white">Elevating businesses to new heights through innovative financial solutions and a relentless drive for improvement and success.</p>
                            </div>
                            <div class="footer-social-icon">
                                <span>Follow us</span>
                                <div class="icon"><a href="#" class="icon"><i class="bi bi-instagram  inst"></i></a></div>
                                <div class="icon"><a href="#" class="icon"><i class="bi bi-facebook  facebook"></i></a></div>
                                <div class="icon"><a href="#" class="icon"><i class="bi bi-twitter  twitter"></i></a></div>
                                <div class="icon"><a href="#" class="icon"><i class="bi bi-linkedin  linkedin"></i></a></div>
                            </div>
                        </div>
                    </div>
